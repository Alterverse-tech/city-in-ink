...
// Park close the north, Ebisu Garden Place the south, Nakameguro's edge the
// west, Aoyama and the Nishi-Azabu edge the east.
...
// the plateaus — so the grid stays tight enough to keep the slopes honest.
...
// ([fraction of roof height, footprint scale]) — the Shibuya station towers
// are all a low-rise podium over the tracks with a slimmer shaft above it.
// `place` entries are labels only (the crossing, parks, the shrine).
// Coordinates were checked against the fetched OSM footprints with
// `node shibuya/check-landmarks.mjs`.
export const LANDMARKS = {
  scramble_square: { label: 'Shibuya Scramble Square', latitude: 35.65845, longitude: 139.70225, heightMeters: 230,
    tiers: [[0.2, 1], [0.92, 0.62], [1, 0.5]] },
  hikarie:         { label: 'Shibuya Hikarie', latitude: 35.65905, longitude: 139.70365, heightMeters: 183,
    tiers: [[0.3, 1], [1, 0.72]] },
  stream:          { label: 'Shibuya Stream', latitude: 35.65700, longitude: 139.70285, heightMeters: 180,
    tiers: [[0.16, 1], [1, 0.66]] },
  cerulean:        { label: 'Cerulean Tower', latitude: 35.65630, longitude: 139.69905, heightMeters: 184,
    tiers: [[0.14, 1], [1, 0.62]] },
  sakura_stage:    { label: 'Shibuya Sakura Stage', latitude: 35.65675, longitude: 139.70045, heightMeters: 179,
    tiers: [[0.18, 1], [1, 0.7]] },
  mark_city:       { label: 'Shibuya Mark City', latitude: 35.65805, longitude: 139.69935, heightMeters: 108, tiers: [[1, 1]] },
  shibuya_109:     { label: 'Shibuya 109', latitude: 35.65965, longitude: 139.69865, heightMeters: 44, tiers: [[1, 1]] },
  parco:           { label: 'Shibuya PARCO', latitude: 35.66205, longitude: 139.69845, heightMeters: 110, tiers: [[0.5, 1], [1, 0.8]] },
  yoyogi_gym:      { label: 'Yoyogi National Gymnasium', latitude: 35.66730, longitude: 139.69975, heightMeters: 40, tiers: [[1, 1]] },
  nhk:             { label: 'NHK Broadcasting Center', latitude: 35.66525, longitude: 139.69545, heightMeters: 90, tiers: [[1, 1]] },
  omotesando_hills:{ label: 'Omotesando Hills', latitude: 35.66760, longitude: 139.70840, heightMeters: 23, tiers: [[1, 1]] },
  ebisu_garden_place:{ label: 'Yebisu Garden Place Tower', latitude: 35.64270, longitude: 139.71340, heightMeters: 167,
    tiers: [[0.1, 1], [1, 0.8]] },
  ...
  harajuku_station:{ label: 'Harajuku Station', latitude: 35.67020, longitude: 139.70270, heightMeters: 0, place: true },
  miyashita_park:  { label: 'Miyashita Park', latitude: 35.66130, longitude: 139.70280, heightMeters: 0, place: true },
  daikanyama:      { label: 'Daikanyama T-Site', latitude: 35.64930, longitude: 139.69990, heightMeters: 0, place: true },
};

// The Tech Week layer's fixed places in this world.
export const WORLD = {
  timeZone: 'Asia/Tokyo',
  harbor: { lat: 35.6712, lng: -0 + 139.6949 },        // no water here: the holding pattern circles over Yoyogi Park
  mast: { lat: 35.65905, lng: 139.70058 },              // leaderboard mast on Hachikō Square
  flagship: { lat: 35.65845, lng: 139.70225, y: 330 },  // week banner above Shibuya Scramble Square
  ...
  neighborhoods: [
    ...
    ['Jinnan', 35.6625, 139.7000], ['Miyashita Park', 35.6613, 139.7028], ['Aoyama', 35.6650, 139.7150],
    ['Omotesando', 35.6655, 139.7120], ['Jingumae', 35.6670, 139.7060], ['Harajuku', 35.6702, 139.7027],
    ...
    ['Ebisu', 35.6467, 139.7101], ['Ebisu Garden Place', 35.6428, 139.7132], ['Hiroo', 35.6520, 139.7215],
...
export const VIEWS = [
  ...
  { id: 'sakura_stage', short: 'Sakura Stage', name: 'Shibuya Sakura Stage', fact: 'A 179 m tower over the Sakuragaoka slope, completed in 2023 as the last piece of the station redevelopment.' },
...
export const LABELS = ['scramble_square', 'hikarie', 'stream', 'cerulean', 'sakura_stage', 'mark_city', 'shibuya_109', 'parco', 'yoyogi_gym', 'nhk',
  'omotesando_hills', 'ebisu_garden_place', 'scramble_crossing', 'hachiko', 'meiji_jingu', 'yoyogi_park', 'harajuku_station', 'miyashita_park', 'daikanyama'];

// Local metres, x east, y up, z south. The overview stands south-west over
// Nanpeidai looking at the station towers; the tour is ~12 passes.
export const CAMERA = {
...
export const PORTRAIT = {
  paragraph: 'Building footprints, streets and water come from OpenStreetMap; the ground is the Geospatial Information Authority of Japan’s 10 m elevation mesh (地理院タイル 標高タイル). The footprints keep their mapped coordinates and courtyards; heights follow the mapped height or storey count, and an unknown height is a low block. The named towers step back to their published massing. Facade colours and window patterns are illustrative. Two-tone shading, fine ink lines and distance fog keep the city in its Sable-inspired palette.',
  buildings: '30,000', streets: '9,000',
};
