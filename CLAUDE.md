...
- **Pushing to `main` creates a Chrona submission automatically** (`.github/workflows/chrona-submit.yml` → `.github/chrona-submit.mjs`); releasing is a human click (Accept & publish) in the Chrona Studio. Do not add publish steps to CI.
