...
- **Expected in standalone mode, not bugs:** CORS errors for `cdn.tech-week.com` posters; `/events.json` 404 (the saved data in `data/` is used); sign-in and multiplayer go to the *test* control plane.
